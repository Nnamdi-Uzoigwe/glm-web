    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-[#1B3A6B] text-2xl">Welcome Back</h1>
          <p className="text-gray-400 text-sm mt-1">Sign in to your GLM account</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/forgot-password" className="text-xs text-[#1B3A6B] hover:text-[#C9902A] transition-colors">
                  Forgot password?
                </Link>
              </div>
              <input
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#1B3A6B] hover:bg-[#C9902A] disabled:opacity-60 text-white font-semibold py-3.5 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 mt-2"
            >
              {loading ? (
                <>
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          ...
          <Link href="/register" className="text-[#1B3A6B] hover:text-[#C9902A] font-semibold transition-colors">
            Create one free
          </Link>
        </p>
      </div>
