import { devotionals } from "@/lib/ministry";
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-16 lg:py-24">
        <div className="max-w-2xl">
          ...
          <div className="bg-white/10 border border-white/20 rounded-xl p-4 inline-block">
            <p className="text-xs text-[#C9902A] font-semibold uppercase tracking-wider mb-1">
              Today's Scripture
            </p>
...
export function TodaysDevotional() {
  const today = devotionals[0];
  return (
    <section className="bg-white py-16 lg:py-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="bg-[#1B3A6B] rounded-2xl p-7 mb-8 relative overflow-hidden">
          ...
          <p className="text-[#C9902A] text-xs font-semibold uppercase tracking-widest mb-3">
            {today.scripture}
          </p>
    ...
    <section className="bg-gray-50 py-14 lg:py-20">
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex items-end justify-between mb-10">
          <div>
            <span className="text-[#C9902A] text-xs font-semibold tracking-[3px] uppercase mb-2 block">
              Archive
            </span>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {archive.map((dev) => (
            <div
              key={dev.id}
              className="group bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-md hover:border-[#1B3A6B]/20 transition-all duration-300"
            >
              <p className="text-xs text-[#C9902A] font-semibold uppercase tracking-wide mb-1">
                {dev.date}
              </p>
              <h3 className="font-serif text-[#1B3A6B] text-lg leading-snug mb-2 group-hover:text-[#C9902A] transition-colors">
                {dev.title}
              </h3>
