  ...
  return (
    <>
      ...
      <section className="font-dm relative min-h-screen flex items-center overflow-hidden">
        ...
        {/* Gold glow accent */}
        <div
          className="absolute top-1/4 right-16 w-96 h-96 rounded-full pointer-events-none z-0"
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 pt-28 pb-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="animate-content-up">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl font-medium text-[0.95rem] text-white border border-white/20 backdrop-blur-sm transition-all duration-200 hover:bg-white/[0.14] hover:border-white/30"
          ...
          <div className="relative hidden lg:block">
            ...
            <div
              ...
              style={{ background: "#1B3A6B", borderColor: "rgba(201,144,42,0.4)" }}
            >
              <div
            ...
            >
              {/* Gold top bar */}
              <div
                className="absolute top-0 left-0 right-0 h-0.73"
